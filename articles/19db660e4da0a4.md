...
Python の`print()`や JavaScript の`console.log()`、PHP の`var_dump()`。これらはあらゆる型の変数を print できる関数で、**デバッグにめちゃくちゃ便利です。**デバッガを使うほど時間をかけたくないとか、プログラムを止めずに変数の中身のログがとりたいと思った時にこれらの関数はめちゃくちゃ便利なので、僕は良く使っています。
...
以下は[このライブラリの README.md](https://github.com/philip82148/cpp-dump)を ChatGPT を使って日本語に訳したものをベースにところどころ編集したものです！
僕(人間)が書いた記事を読みたい場合は次の記事を読んでください！
